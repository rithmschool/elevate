    ...
    const admin = (
      <AdminContext.Consumer>
        {isAdmin => (
          <li className="nav-item active">
            {isAdmin ? (
              <Link to="/admin" className="Nav-text Nav-link Nav-link-ltr">
                Admin
              </Link>
            ) : (
              ""
        ...
        >
          <ul className="navbar-nav mr-auto">
            <li
              ...
              data-target=".in"
            >
              <Link to="/link1" className="Nav-link Nav-link-ltr">
                Get Started
              </Link>
            </li>
            <li className="nav-item active">
              <Link to="/link2" className="Nav-link Nav-link-ltr ">
                How it Works
              </Link>
            </li>
            <li className="nav-item active">
              <Link to="/link3" className="Nav-text Nav-link Nav-link-ltr">
                About
              </Link>
            </li>
            {admin}
          ...
          <ul className="navbar-nav">
            <li className="nav-item active">
              <Link to="/link3" className="Nav-link Nav-link-ltr">
                Help
              </Link>
            </li>
            {login}
